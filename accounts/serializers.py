...
"""Serializers UserSerializer sends all users."""
class UsersSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ('full_name', 'email', 'id', 'is_active', 'admin', 'normal_user', 'advanced_user', 'staff')
...
class UserDataSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        # The reason we want to use `read_only_fields` here is that
...
# Register Users in the application
class RegistrationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['email', 'full_name', 'password1', 'password2', 'token']
...
# To be used to login the users in the  mobile application
