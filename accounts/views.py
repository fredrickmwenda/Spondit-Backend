...
from .serializers import DeviceSerializer, LoginSerializer, RegistrationSerializer, UserDevicesSerializer, UsersSerializer
...
#     permission_class = (AllowAny)
   # serializer_class = DeviceSerializer
    ...
    #     return Response(serializer.data)
        ...
        #         'success': True,
        #         'status_code': status.HTTP_200_OK,
        #         'message': 'Successfully fetched 2 devices',
        #         'devices': serializer.data
